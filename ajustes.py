...
# --- Configuración base ---
RUTA_BASE = Path(__file__).parent.parent  # Usamos Path para mayor robustez
...
URL_ACM = "https://dl.acm.org/action/doSearch?AllField=computational+thinking"
URL_SCIENCEDIRECT = "https://www-sciencedirect-com.crai.referencistas.com/search?qs=computational%20thinking"
