...
en los abstracts de los articulos
"""
def plot_keyword_frequencies(freqs, output_path="src/outputs/keywords_analizer/keywords_freq.png"):
...
"""
def plot_new_terms_tfidf_vs_freq(abstracts, top_terms, output_path="src/outputs/keywords_analizer/new_terms_tfidf_freq.png"):
    os.makedirs(os.path.dirname(output_path), exist_ok=True)
...
"""
def plot_precision_and_terms(precision, common_terms, output_path="src/outputs/keywords_analizer/precision_terms.png"):
