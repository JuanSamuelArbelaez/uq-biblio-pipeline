...
""""
Ejemplo de entrada:
python3 utils/compare_articles.py --compare_ids cons1,cons3
"""
...
se traen en el formato:
    {
        "cons1": "texto del abstract 1",
        "cons2": "texto del abstract 2",
        ...
    }
"""
...
La comparación se hace con todas la funciones requeridas
    :param abstracts: diccionario con abstracts, ej. {"cons1": "...", "cons2": "..."}
    :param article_ids: lista de IDs a comparar, ej. ["cons1", "cons2"]
"""
...
if __name__ == "__main__":
    ...
    if args.compare_ids:
        ids_str = args.compare_ids
    else:
        print("⚠️ No se especificaron IDs, usando por defecto: cons1, cons2")
        ids_str = "cons1,cons2"

    output = run_comparison_from_ids(ids_str)
    print(output)
