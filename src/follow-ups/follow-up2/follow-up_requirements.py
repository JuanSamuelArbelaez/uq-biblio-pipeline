...
def main_requirement1():
    ...
    # 1. Cargar artículos
    articles = parse_bib_file("src/datos/bib/consolidado.bib")
    ...
    # 5. Visualizar grafo
    visualize_graph_connected(G, "src/follow-ups/follow-up2/outputs/citation_graph_connected.png", label_type="id", show_edge_weights=True)

def main_requirement2():
    print(f"\n---------------- Requerimiento 2 ----------------")

    # 1. Cargar abstracts
    abstracts = load_abstracts_from_bib("src/datos/bib/consolidado.bib")
